...
public class ATFrameInterpreter extends AbstractFrameInterpreterImpl {
	@Override
	public synchronized Cmd byteArray2Cmd(final byte[] stream) {
		ATRetCmd atCmd = AtcmdsetFactory.eINSTANCE.createATRetCmd();
		atCmd.setData(stream);
		return atCmd;
	}
}
