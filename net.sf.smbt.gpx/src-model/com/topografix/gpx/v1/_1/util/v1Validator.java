 ...
 * @generated
 */
public class v1Validator extends EObjectValidator {
	/**
	 ...
	 * @generated
	 */
	public static final v1Validator INSTANCE = new v1Validator();
	 ...
	 * @generated
	 */
	public static final String DIAGNOSTIC_SOURCE = "com.topografix.gpx.v1._1";
	...
	public boolean validateDegreesType_Min(BigDecimal degreesType, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (!result && diagnostics != null)
			reportMinViolation(v1Package.Literals.DEGREES_TYPE, degreesType, DEGREES_TYPE__MIN__VALUE, true, diagnostics, context);
		return result;
	}
	...
	public boolean validateDegreesType_Max(BigDecimal degreesType, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (!result && diagnostics != null)
			reportMaxViolation(v1Package.Literals.DEGREES_TYPE, degreesType, DEGREES_TYPE__MAX__VALUE, false, diagnostics, context);
		return result;
	}
	...
	public boolean validateDgpsStationType_Min(BigInteger dgpsStationType, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (!result && diagnostics != null)
			reportMinViolation(v1Package.Literals.DGPS_STATION_TYPE, dgpsStationType, DGPS_STATION_TYPE__MIN__VALUE, true, diagnostics, context);
		return result;
	}
	...
	public boolean validateDgpsStationType_Max(BigInteger dgpsStationType, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (!result && diagnostics != null)
			reportMaxViolation(v1Package.Literals.DGPS_STATION_TYPE, dgpsStationType, DGPS_STATION_TYPE__MAX__VALUE, true, diagnostics, context);
		return result;
	}
	...
	public boolean validateLatitudeType_Min(BigDecimal latitudeType, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (!result && diagnostics != null)
			reportMinViolation(v1Package.Literals.LATITUDE_TYPE, latitudeType, LATITUDE_TYPE__MIN__VALUE, true, diagnostics, context);
		return result;
	}
	...
	public boolean validateLatitudeType_Max(BigDecimal latitudeType, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (!result && diagnostics != null)
			reportMaxViolation(v1Package.Literals.LATITUDE_TYPE, latitudeType, LATITUDE_TYPE__MAX__VALUE, true, diagnostics, context);
		return result;
	}
	...
	public boolean validateLongitudeType_Min(BigDecimal longitudeType, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (!result && diagnostics != null)
			reportMinViolation(v1Package.Literals.LONGITUDE_TYPE, longitudeType, LONGITUDE_TYPE__MIN__VALUE, true, diagnostics, context);
		return result;
	}
	...
	public boolean validateLongitudeType_Max(BigDecimal longitudeType, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (!result && diagnostics != null)
			reportMaxViolation(v1Package.Literals.LONGITUDE_TYPE, longitudeType, LONGITUDE_TYPE__MAX__VALUE, false, diagnostics, context);
		return result;
	}
