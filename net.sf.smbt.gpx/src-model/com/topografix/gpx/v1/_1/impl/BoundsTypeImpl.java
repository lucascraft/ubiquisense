 ...
 * <ul>
 *   <li>{@link com.topografix.gpx.v1._1.impl.BoundsTypeImpl#getMaxlat <em>Maxlat</em>}</li>
 *   <li>{@link com.topografix.gpx.v1._1.impl.BoundsTypeImpl#getMaxlon <em>Maxlon</em>}</li>
 *   <li>{@link com.topografix.gpx.v1._1.impl.BoundsTypeImpl#getMinlat <em>Minlat</em>}</li>
 *   <li>{@link com.topografix.gpx.v1._1.impl.BoundsTypeImpl#getMinlon <em>Minlon</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class BoundsTypeImpl extends EObjectImpl implements BoundsType {
	...
	protected EClass eStaticClass() {
		return v1Package.Literals.BOUNDS_TYPE;
	}
	...
	public void setMaxlat(BigDecimal newMaxlat) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, v1Package.BOUNDS_TYPE__MAXLAT, oldMaxlat, maxlat));
	}
	...
	public void setMaxlon(BigDecimal newMaxlon) {
		...
		maxlon = newMaxlon;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, v1Package.BOUNDS_TYPE__MAXLON, oldMaxlon, maxlon));
	}
	...
	public void setMinlat(BigDecimal newMinlat) {
		...
		minlat = newMinlat;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, v1Package.BOUNDS_TYPE__MINLAT, oldMinlat, minlat));
	}
	...
	public void setMinlon(BigDecimal newMinlon) {
		...
		minlon = newMinlon;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, v1Package.BOUNDS_TYPE__MINLON, oldMinlon, minlon));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case v1Package.BOUNDS_TYPE__MAXLAT:
				return getMaxlat();
			case v1Package.BOUNDS_TYPE__MAXLON:
				return getMaxlon();
			case v1Package.BOUNDS_TYPE__MINLAT:
				return getMinlat();
			case v1Package.BOUNDS_TYPE__MINLON:
				return getMinlon();
		}
