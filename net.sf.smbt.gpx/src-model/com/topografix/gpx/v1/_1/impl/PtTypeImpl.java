 ...
 * <ul>
 *   <li>{@link com.topografix.gpx.v1._1.impl.PtTypeImpl#getEle <em>Ele</em>}</li>
 *   <li>{@link com.topografix.gpx.v1._1.impl.PtTypeImpl#getTime <em>Time</em>}</li>
 *   <li>{@link com.topografix.gpx.v1._1.impl.PtTypeImpl#getLat <em>Lat</em>}</li>
 *   <li>{@link com.topografix.gpx.v1._1.impl.PtTypeImpl#getLon <em>Lon</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class PtTypeImpl extends EObjectImpl implements PtType {
	/**
	...
	protected EClass eStaticClass() {
		return v1Package.Literals.PT_TYPE;
	}
	...
	public void setEle(BigDecimal newEle) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, v1Package.PT_TYPE__ELE, oldEle, ele));
	}
	...
	public void setTime(XMLGregorianCalendar newTime) {
		...
		time = newTime;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, v1Package.PT_TYPE__TIME, oldTime, time));
	}
	...
	public void setLat(BigDecimal newLat) {
		...
		lat = newLat;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, v1Package.PT_TYPE__LAT, oldLat, lat));
	}
	...
	public void setLon(BigDecimal newLon) {
		...
		lon = newLon;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, v1Package.PT_TYPE__LON, oldLon, lon));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case v1Package.PT_TYPE__ELE:
				return getEle();
			case v1Package.PT_TYPE__TIME:
				return getTime();
			case v1Package.PT_TYPE__LAT:
				return getLat();
			case v1Package.PT_TYPE__LON:
				return getLon();
		}
