...
/**
 * This is the item provider adapter for a {@link net.sf.smbt.ezoscmidi.OscMidiCmd} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class OscMidiCmdItemProvider
	 ...
	 * @generated
	 */
	public OscMidiCmdItemProvider(AdapterFactory adapterFactory) {
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/OscMidiCmd"));
	}
	...
	public String getText(Object object) {
		PRIORITY labelValue = ((OscMidiCmd)object).getPriority();
		String label = labelValue == null ? null : labelValue.toString();
		return label == null || label.length() == 0 ?
			getString("_UI_OscMidiCmd_type") :
			getString("_UI_OscMidiCmd_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(OscMidiCmd.class)) {
			case EzoscmidiPackage.OSC_MIDI_CMD__ADDR:
			case EzoscmidiPackage.OSC_MIDI_CMD__MSG_SIZE:
			case EzoscmidiPackage.OSC_MIDI_CMD__BYTE1:
			case EzoscmidiPackage.OSC_MIDI_CMD__BYTE2:
			case EzoscmidiPackage.OSC_MIDI_CMD__MESSAGE:
	...
	public ResourceLocator getResourceLocator() {
		return EzoscmidiEditPlugin.INSTANCE;
	}
