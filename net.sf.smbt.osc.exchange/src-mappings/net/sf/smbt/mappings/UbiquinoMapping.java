...
import net.sf.smbt.mappings.ubiquino.Osc2UbiquinoMapping;
import net.sf.smbt.mappings.ubiquino.Ubiquino2OscMapping;
...
public class UbiquinoMapping extends AbstractMapEngine {

	@Override
	public Cmd ez2cmd(Cmd leftCmd) {
		return Osc2UbiquinoMapping.INSTANCE.osc2ubiquino((OSCMessage)((OscCmd)leftCmd).getMsg());
	}

	@Override
	public Cmd cmd2ez(Cmd leftCmd) {
		return Ubiquino2OscMapping.INSTANCE.ubiquino2osc((FirmataCmd)leftCmd);
	}
