...
public class ArduinoConnectionWizardPage extends WizardPage {
	/**
	...
	public ArduinoConnectionWizardPage() {
		super("USB");
	    	...
	    	new ISelectionChangedListener() {
				...
				public void selectionChanged(SelectionChangedEvent event) {
					if (event.getSelection() instanceof IStructuredSelection) {
						((ArduinoConnectionSelectionWizard)getWizard()).cfg.setUsbComm(
