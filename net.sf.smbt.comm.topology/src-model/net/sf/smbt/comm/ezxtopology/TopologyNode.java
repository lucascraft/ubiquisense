...
/**
 * <!-- begin-user-doc -->
 * A representation of the model object '<em><b>Topology Node</b></em>'.
 * <!-- end-user-doc -->
 *
 * <p>
 * The following features are supported:
 * <ul>
 *   <li>{@link net.sf.smbt.comm.ezxtopology.TopologyNode#getDevice <em>Device</em>}</li>
 *   <li>{@link net.sf.smbt.comm.ezxtopology.TopologyNode#getMime <em>Mime</em>}</li>
 *   <li>{@link net.sf.smbt.comm.ezxtopology.TopologyNode#getID <em>ID</em>}</li>
 *   <li>{@link net.sf.smbt.comm.ezxtopology.TopologyNode#getHeartBeat <em>Heart Beat</em>}</li>
 * </ul>
 * </p>
 *
 * @see net.sf.smbt.comm.ezxtopology.EzxtopologyPackage#getTopologyNode()
 * @model
 * @generated
 */
