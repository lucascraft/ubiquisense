...
public class UsbTopologyVisitor <N extends AbstractTopologyItem> extends AbstractTopologyVisitor<N> {
	
	public UsbTopologyVisitor(List<XCPAddress> addresses, boolean withReconciliation) {
