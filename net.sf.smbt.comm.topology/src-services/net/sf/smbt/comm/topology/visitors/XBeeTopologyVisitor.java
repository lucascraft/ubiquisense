...
public class XBeeTopologyVisitor <N extends AbstractTopologyItem> extends AbstractTopologyVisitor<N> {
	
	public XBeeTopologyVisitor(List<XCPAddress> addresses, boolean withReconciliation) {
