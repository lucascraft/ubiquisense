...
public class TcpTopologyVisitor <N extends AbstractTopologyItem> extends AbstractTopologyVisitor<N> {
	
	public TcpTopologyVisitor(List<XCPAddress> addresses, boolean withReconciliation) {
