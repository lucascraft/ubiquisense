...
public class OscMessageCreationDialog extends SelectionDialog {
   ...
   private final static int LIST_WIDTH = 20;
	...
	public OscMessageCreationDialog(Shell parentShell, String shellTitle, String shellMessage, float factor) {
		super(parentShell);
     ...
     */
	public OscMessageCreationDialog(Shell parentShell, String shellTitle, String shellMessage) {
    ...
    private TabItem previousOscLinks(TabFolder folder, Font font) {
        ...
        pListViewer.getControl().setBackground(GUIToolkit.BG);
