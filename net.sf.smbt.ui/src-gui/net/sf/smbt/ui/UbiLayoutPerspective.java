...
public class UbiLayoutPerspective implements IPerspectiveFactory {

	public final static String ProximiSensePerspectiveID = "net.sf.smbt.ui.layout.perspective";
