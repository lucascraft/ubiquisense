...
public class GUIColors {
	 ...
	 *            the display to use
	 */
	public GUIColors(Display display) {
		//ITheme curTheme = PlatformUI.getWorkbench().getThemeManager().getCurrentTheme();

		//	curTheme.getColorRegistry().getColorDescriptor();
	...
	protected void initialize() {
		background = new Color(Display.getDefault(), new RGB(100, 100, 100));
		foreground = new Color(Display.getDefault(), new RGB(200, 200, 200));
