...
public class EZTargetDragAdapter extends DragSourceAdapter {

	private TreeViewer viewer;
	
	public EZTargetDragAdapter(TreeViewer treeViewer) {
		this.viewer = treeViewer;
	}

	@Override
	public void dragSetData(DragSourceEvent event) {
		event.dataType = EZTargetTransfertData.INSTANCE;
	}
   ...
   void performEZTargetDragSetData(DragSourceEvent event) {
        if (EZTargetTransfert.INSTANCE.isSupportedType(event.dataType)) {
