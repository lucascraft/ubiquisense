 ...
 * <ul>
 *   <li>{@link com.google.earth.kml._2.impl.LinearRingTypeImpl#isExtrude <em>Extrude</em>}</li>
 *   <li>{@link com.google.earth.kml._2.impl.LinearRingTypeImpl#isTessellate <em>Tessellate</em>}</li>
 *   <li>{@link com.google.earth.kml._2.impl.LinearRingTypeImpl#getAltitudeMode <em>Altitude Mode</em>}</li>
 *   <li>{@link com.google.earth.kml._2.impl.LinearRingTypeImpl#getCoordinates <em>Coordinates</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class LinearRingTypeImpl extends GeometryTypeImpl implements LinearRingType {
	/**
	...
	protected EClass eStaticClass() {
		return v21Package.Literals.LINEAR_RING_TYPE;
	}
	...
	public void setExtrude(boolean newExtrude) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, v21Package.LINEAR_RING_TYPE__EXTRUDE, oldExtrude, extrude, !oldExtrudeESet));
	}
	...
	public void unsetExtrude() {
		...
		extrudeESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, v21Package.LINEAR_RING_TYPE__EXTRUDE, oldExtrude, EXTRUDE_EDEFAULT, oldExtrudeESet));
	}
	...
	public void setTessellate(boolean newTessellate) {
		...
		tessellateESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, v21Package.LINEAR_RING_TYPE__TESSELLATE, oldTessellate, tessellate, !oldTessellateESet));
	}
	...
	public void unsetTessellate() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, v21Package.LINEAR_RING_TYPE__TESSELLATE, oldTessellate, TESSELLATE_EDEFAULT, oldTessellateESet));
	}
	...
	public void setAltitudeMode(AltitudeModeEnum newAltitudeMode) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, v21Package.LINEAR_RING_TYPE__ALTITUDE_MODE, oldAltitudeMode, altitudeMode, !oldAltitudeModeESet));
	}
	...
	public void unsetAltitudeMode() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, v21Package.LINEAR_RING_TYPE__ALTITUDE_MODE, oldAltitudeMode, ALTITUDE_MODE_EDEFAULT, oldAltitudeModeESet));
	}
	...
	public void setCoordinates(List<String> newCoordinates) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, v21Package.LINEAR_RING_TYPE__COORDINATES, oldCoordinates, coordinates));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case v21Package.LINEAR_RING_TYPE__EXTRUDE:
				return isExtrude();
			case v21Package.LINEAR_RING_TYPE__TESSELLATE:
				return isTessellate();
			case v21Package.LINEAR_RING_TYPE__ALTITUDE_MODE:
				return getAltitudeMode();
			case v21Package.LINEAR_RING_TYPE__COORDINATES:
