 ...
 * <ul>
 *   <li>{@link com.google.earth.kml._2.impl.DocumentTypeImpl#getFeatureGroup <em>Feature Group</em>}</li>
 *   <li>{@link com.google.earth.kml._2.impl.DocumentTypeImpl#getFeature <em>Feature</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class DocumentTypeImpl extends ContainerTypeImpl implements DocumentType {
	/**
	...
	protected EClass eStaticClass() {
		return v21Package.Literals.DOCUMENT_TYPE;
	}
	...
	public FeatureMap getFeatureGroup() {
		if (featureGroup == null) {
			featureGroup = new BasicFeatureMap(this, v21Package.DOCUMENT_TYPE__FEATURE_GROUP);
		}
		return featureGroup;
	}
	...
	public EList<FeatureType> getFeature() {
		return getFeatureGroup().list(v21Package.Literals.DOCUMENT_TYPE__FEATURE);
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case v21Package.DOCUMENT_TYPE__FEATURE_GROUP:
				return ((InternalEList<?>)getFeatureGroup()).basicRemove(otherEnd, msgs);
			case v21Package.DOCUMENT_TYPE__FEATURE:
