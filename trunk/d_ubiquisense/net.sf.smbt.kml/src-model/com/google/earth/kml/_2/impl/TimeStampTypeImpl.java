 ...
 * <ul>
 *   <li>{@link com.google.earth.kml._2.impl.TimeStampTypeImpl#getWhen <em>When</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class TimeStampTypeImpl extends TimePrimitiveTypeImpl implements TimeStampType {
	/**
	...
	protected EClass eStaticClass() {
		return v21Package.Literals.TIME_STAMP_TYPE;
	}
	...
	public void setWhen(XMLGregorianCalendar newWhen) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, v21Package.TIME_STAMP_TYPE__WHEN, oldWhen, when));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case v21Package.TIME_STAMP_TYPE__WHEN:
				return getWhen();
		}
