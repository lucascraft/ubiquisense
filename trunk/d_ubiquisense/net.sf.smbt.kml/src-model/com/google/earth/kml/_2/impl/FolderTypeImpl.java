 ...
 * <ul>
 *   <li>{@link com.google.earth.kml._2.impl.FolderTypeImpl#getFeatureGroup <em>Feature Group</em>}</li>
 *   <li>{@link com.google.earth.kml._2.impl.FolderTypeImpl#getFeature <em>Feature</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class FolderTypeImpl extends ContainerTypeImpl implements FolderType {
	/**
	...
	protected EClass eStaticClass() {
		return v21Package.Literals.FOLDER_TYPE;
	}
	...
	public FeatureMap getFeatureGroup() {
		if (featureGroup == null) {
			featureGroup = new BasicFeatureMap(this, v21Package.FOLDER_TYPE__FEATURE_GROUP);
		}
		return featureGroup;
	}
	...
	public EList<FeatureType> getFeature() {
		return getFeatureGroup().list(v21Package.Literals.FOLDER_TYPE__FEATURE);
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case v21Package.FOLDER_TYPE__FEATURE_GROUP:
				return ((InternalEList<?>)getFeatureGroup()).basicRemove(otherEnd, msgs);
			case v21Package.FOLDER_TYPE__FEATURE:
