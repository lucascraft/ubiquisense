 ...
 * @generated
 */
public class HttpcmdSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case HttpcmdPackage.PROPERTY: {
				Property property = (Property)theEObject;
				T result = caseProperty(property);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case HttpcmdPackage.HTTP_COMM_CMD: {
				HttpCommCmd httpCommCmd = (HttpCommCmd)theEObject;
				T result = caseHttpCommCmd(httpCommCmd);
				if (result == null) result = caseCmd(httpCommCmd);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
