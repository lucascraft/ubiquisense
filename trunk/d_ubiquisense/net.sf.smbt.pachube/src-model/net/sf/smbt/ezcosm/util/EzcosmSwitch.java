 ...
 * @generated
 */
public class EzcosmSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case EzcosmPackage.COSM_PROJECT: {
				CosmProject cosmProject = (CosmProject)theEObject;
				T result = caseCosmProject(cosmProject);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case EzcosmPackage.COORDINATES: {
				Coordinates coordinates = (Coordinates)theEObject;
				T result = caseCoordinates(coordinates);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case EzcosmPackage.TRIGGER: {
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Cosm Project</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Cosm Project</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseCosmProject(CosmProject object) {
		return null;
	}
