...
package net.sf.smbt.firmata.ubiquino.ui;

import net.sf.smbt.ui.logging.page.SmbtLogListener;
...
public class Activator extends AbstractUIPlugin {
	...
	// The plug-in ID
	public static final String PLUGIN_ID = "net.sf.smbt.ui.firmata.ubiquino"; //$NON-NLS-1$
	...
	public void start(BundleContext context) throws Exception {
		super.start(context);
		plugin = this;
		plugin.getLog().addLogListener(new SmbtLogListener());
	}
