...
public class UbiquinoSheetLabelProvider extends BaseLabelProvider implements
		ILabelProvider {

	public String getText(Object selection) {
		Object element = unwrap(selection);
		if (element instanceof Ubiquino && ((Ubiquino) element).getBoard() != null) {
			String label = ((Ubiquino) element).getBoard().getKind()
					.getLiteral();
			return "Board : " + (label == null ? "" : label);
		}
		return "???";
	}
	...
	public Image getImage(Object element) {
		return Activator.imageDescriptorFromPlugin(Activator.PLUGIN_ID,
				"icons/ubiquisense.png").createImage();
	}
