...
public abstract class AbstractUbiquinoOutlinePage extends Page implements IContentOutlinePage, ISelectionChangedListener, IAdaptable {

	/** Flag set during selection modification */
	private boolean isDispatching = false;

	private AbstractUbiquinoModelNavigator navigator;
...
//	private CollapseAllHandler collapseAllHandler;
	 ...
	 */
	public AbstractUbiquinoOutlinePage(UbiquinoEditor ed) {
 ...
 */
	...
	public void createControl(Composite parent) {
		...
		sashComp.setWeights(new int[] { 100 });
...
//	}
	 ...
	 */
	protected abstract AbstractUbiquinoModelNavigator createNavigator(Composite parent, IPageSite pageSite);
