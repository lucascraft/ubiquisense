...
public abstract class AbstractCosmOutlinePage extends Page implements IContentOutlinePage, ISelectionChangedListener, IAdaptable {
	...
	private AbstractCosmModelNavigator navigator;
...
//	private CollapseAllHandler collapseAllHandler;
	 ...
	 */
	public AbstractCosmOutlinePage(CosmEditor ed) {
...
//	}
	 ...
	 * @return the editor
	 */
	protected CosmEditor getEditor() {
		return editor;
	}
	 ...
	 */
	protected abstract AbstractCosmModelNavigator createNavigator(Composite parent, IPageSite pageSite);
