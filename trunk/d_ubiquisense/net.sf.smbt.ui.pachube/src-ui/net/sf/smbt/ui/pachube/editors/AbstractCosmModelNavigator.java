...
public abstract class AbstractCosmModelNavigator extends Composite implements IMenuListener {
	 ...
	 *            the site
	 */
	public AbstractCosmModelNavigator(Composite parent, CosmEditor diagEditor, IPageSite pageSite) {
