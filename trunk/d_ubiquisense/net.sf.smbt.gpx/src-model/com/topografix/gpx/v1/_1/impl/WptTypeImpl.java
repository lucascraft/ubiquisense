...
import com.topografix.gpx.v1._1.FixType;
 ...
 * <ul>
 *   <li>{@link com.topografix.gpx.v1._1.impl.WptTypeImpl#getEle <em>Ele</em>}</li>
 *   <li>{@link com.topografix.gpx.v1._1.impl.WptTypeImpl#getTime <em>Time</em>}</li>
 *   <li>{@link com.topografix.gpx.v1._1.impl.WptTypeImpl#getMagvar <em>Magvar</em>}</li>
 *   <li>{@link com.topografix.gpx.v1._1.impl.WptTypeImpl#getGeoidheight <em>Geoidheight</em>}</li>
 *   <li>{@link com.topografix.gpx.v1._1.impl.WptTypeImpl#getName <em>Name</em>}</li>
 *   <li>{@link com.topografix.gpx.v1._1.impl.WptTypeImpl#getCmt <em>Cmt</em>}</li>
 *   <li>{@link com.topografix.gpx.v1._1.impl.WptTypeImpl#getDesc <em>Desc</em>}</li>
 *   <li>{@link com.topografix.gpx.v1._1.impl.WptTypeImpl#getSrc <em>Src</em>}</li>
 *   <li>{@link com.topografix.gpx.v1._1.impl.WptTypeImpl#getLink <em>Link</em>}</li>
 *   <li>{@link com.topografix.gpx.v1._1.impl.WptTypeImpl#getSym <em>Sym</em>}</li>
 *   <li>{@link com.topografix.gpx.v1._1.impl.WptTypeImpl#getType <em>Type</em>}</li>
 *   <li>{@link com.topografix.gpx.v1._1.impl.WptTypeImpl#getFix <em>Fix</em>}</li>
 *   <li>{@link com.topografix.gpx.v1._1.impl.WptTypeImpl#getSat <em>Sat</em>}</li>
 *   <li>{@link com.topografix.gpx.v1._1.impl.WptTypeImpl#getHdop <em>Hdop</em>}</li>
 *   <li>{@link com.topografix.gpx.v1._1.impl.WptTypeImpl#getVdop <em>Vdop</em>}</li>
 *   <li>{@link com.topografix.gpx.v1._1.impl.WptTypeImpl#getPdop <em>Pdop</em>}</li>
 *   <li>{@link com.topografix.gpx.v1._1.impl.WptTypeImpl#getAgeofdgpsdata <em>Ageofdgpsdata</em>}</li>
 *   <li>{@link com.topografix.gpx.v1._1.impl.WptTypeImpl#getDgpsid <em>Dgpsid</em>}</li>
 *   <li>{@link com.topografix.gpx.v1._1.impl.WptTypeImpl#getExtensions <em>Extensions</em>}</li>
 *   <li>{@link com.topografix.gpx.v1._1.impl.WptTypeImpl#getLat <em>Lat</em>}</li>
 *   <li>{@link com.topografix.gpx.v1._1.impl.WptTypeImpl#getLon <em>Lon</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class WptTypeImpl extends EObjectImpl implements WptType {
	/**
	...
	protected EClass eStaticClass() {
		return v1Package.Literals.WPT_TYPE;
	}
	...
	public void setEle(BigDecimal newEle) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, v1Package.WPT_TYPE__ELE, oldEle, ele));
	}
	...
	public void setTime(XMLGregorianCalendar newTime) {
		...
		time = newTime;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, v1Package.WPT_TYPE__TIME, oldTime, time));
	}
	...
	public void setMagvar(BigDecimal newMagvar) {
		...
		magvar = newMagvar;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, v1Package.WPT_TYPE__MAGVAR, oldMagvar, magvar));
	}
	...
	public void setGeoidheight(BigDecimal newGeoidheight) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, v1Package.WPT_TYPE__GEOIDHEIGHT, oldGeoidheight, geoidheight));
	}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, v1Package.WPT_TYPE__NAME, oldName, name));
	}
	...
	public void setCmt(String newCmt) {
		...
		cmt = newCmt;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, v1Package.WPT_TYPE__CMT, oldCmt, cmt));
	}
	...
	public void setDesc(String newDesc) {
		...
		desc = newDesc;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, v1Package.WPT_TYPE__DESC, oldDesc, desc));
	}
	...
	public void setSrc(String newSrc) {
		...
		src = newSrc;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, v1Package.WPT_TYPE__SRC, oldSrc, src));
	}
	...
	public EList<LinkType> getLink() {
		if (link == null) {
			link = new EObjectContainmentEList<LinkType>(LinkType.class, this, v1Package.WPT_TYPE__LINK);
		}
		return link;
	}
	...
	public void setSym(String newSym) {
		...
		sym = newSym;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, v1Package.WPT_TYPE__SYM, oldSym, sym));
	}
	...
	public void setType(String newType) {
		...
		type = newType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, v1Package.WPT_TYPE__TYPE, oldType, type));
	}
	...
	public void setFix(FixType newFix) {
		...
		fixESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, v1Package.WPT_TYPE__FIX, oldFix, fix, !oldFixESet));
	}
	...
	public void unsetFix() {
		...
		fixESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, v1Package.WPT_TYPE__FIX, oldFix, FIX_EDEFAULT, oldFixESet));
	}
	...
	public void setSat(BigInteger newSat) {
		...
		sat = newSat;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, v1Package.WPT_TYPE__SAT, oldSat, sat));
	}
	...
	public void setHdop(BigDecimal newHdop) {
		...
		hdop = newHdop;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, v1Package.WPT_TYPE__HDOP, oldHdop, hdop));
	}
	...
	public void setVdop(BigDecimal newVdop) {
		...
		vdop = newVdop;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, v1Package.WPT_TYPE__VDOP, oldVdop, vdop));
	}
	...
	public void setPdop(BigDecimal newPdop) {
		...
		pdop = newPdop;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, v1Package.WPT_TYPE__PDOP, oldPdop, pdop));
	}
	...
	public void setAgeofdgpsdata(BigDecimal newAgeofdgpsdata) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, v1Package.WPT_TYPE__AGEOFDGPSDATA, oldAgeofdgpsdata, ageofdgpsdata));
	}
	...
	public void setDgpsid(BigInteger newDgpsid) {
		...
		dgpsid = newDgpsid;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, v1Package.WPT_TYPE__DGPSID, oldDgpsid, dgpsid));
	}
	...
	public NotificationChain basicSetExtensions(ExtensionsType newExtensions, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, v1Package.WPT_TYPE__EXTENSIONS, oldExtensions, newExtensions);
	...
	public void setExtensions(ExtensionsType newExtensions) {
		if (newExtensions != extensions) {
			...
			if (extensions != null)
				msgs = ((InternalEObject)extensions).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - v1Package.WPT_TYPE__EXTENSIONS, null, msgs);
			if (newExtensions != null)
				msgs = ((InternalEObject)newExtensions).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - v1Package.WPT_TYPE__EXTENSIONS, null, msgs);
			msgs = basicSetExtensions(newExtensions, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, v1Package.WPT_TYPE__EXTENSIONS, newExtensions, newExtensions));
	}
	...
	public void setLat(BigDecimal newLat) {
		...
		lat = newLat;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, v1Package.WPT_TYPE__LAT, oldLat, lat));
	}
	...
	public void setLon(BigDecimal newLon) {
		...
		lon = newLon;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, v1Package.WPT_TYPE__LON, oldLon, lon));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case v1Package.WPT_TYPE__LINK:
				return ((InternalEList<?>)getLink()).basicRemove(otherEnd, msgs);
			case v1Package.WPT_TYPE__EXTENSIONS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case v1Package.WPT_TYPE__ELE:
				return getEle();
			case v1Package.WPT_TYPE__TIME:
				return getTime();
			case v1Package.WPT_TYPE__MAGVAR:
				return getMagvar();
			case v1Package.WPT_TYPE__GEOIDHEIGHT:
				return getGeoidheight();
			case v1Package.WPT_TYPE__NAME:
				return getName();
			case v1Package.WPT_TYPE__CMT:
				return getCmt();
			case v1Package.WPT_TYPE__DESC:
				return getDesc();
			case v1Package.WPT_TYPE__SRC:
				return getSrc();
			case v1Package.WPT_TYPE__LINK:
				return getLink();
			case v1Package.WPT_TYPE__SYM:
				return getSym();
			case v1Package.WPT_TYPE__TYPE:
				return getType();
			case v1Package.WPT_TYPE__FIX:
				return getFix();
			case v1Package.WPT_TYPE__SAT:
				return getSat();
			case v1Package.WPT_TYPE__HDOP:
				return getHdop();
			case v1Package.WPT_TYPE__VDOP:
				return getVdop();
			case v1Package.WPT_TYPE__PDOP:
				return getPdop();
			case v1Package.WPT_TYPE__AGEOFDGPSDATA:
				return getAgeofdgpsdata();
			case v1Package.WPT_TYPE__DGPSID:
				return getDgpsid();
			case v1Package.WPT_TYPE__EXTENSIONS:
				return getExtensions();
			case v1Package.WPT_TYPE__LAT:
				return getLat();
			case v1Package.WPT_TYPE__LON:
				return getLon();
		}
