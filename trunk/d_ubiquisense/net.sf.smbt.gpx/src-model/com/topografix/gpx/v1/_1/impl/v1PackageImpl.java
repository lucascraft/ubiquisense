...
import com.topografix.gpx.v1._1.util.v1Validator;

import com.topografix.gpx.v1._1.v1Factory;
...
public class v1PackageImpl extends EPackageImpl implements v1Package {
	 ...
	 * @see com.topografix.gpx.v1._1.v1Package#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public static v1Package init() {
		...
		v1PackageImpl thev1Package = (v1PackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof v1PackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new v1PackageImpl());
	...
	public EReference getGpxType_Bounds() {
		return (EReference)gpxTypeEClass.getEStructuralFeatures().get(5);
	}
	...
	public EReference getGpxType_Extensions() {
		return (EReference)gpxTypeEClass.getEStructuralFeatures().get(6);
	}
	...
	public EAttribute getGpxType_Version() {
		return (EAttribute)gpxTypeEClass.getEStructuralFeatures().get(8);
	}
	...
	public void initializePackageContents() {
		...
		initEAttribute(getGpxType_Time(), theXMLTypePackage.getTime(), "time", null, 1, 1, GpxType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getGpxType_Bounds(), this.getBoundsType(), null, "bounds", null, 1, 1, GpxType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
