...
public class UbiSliderRange extends UbiWidget {
	...
	public UbiSliderRange(Composite parent, int style) {
		this(parent, style, false, UBI_SLIDER_MINIMAL_LOOK);
	}
	public UbiSliderRange(Composite parent, int style, boolean synchro) {
		this(parent, style, synchro, UBI_SLIDER_MINIMAL_LOOK);
	}
	public UbiSliderRange(Composite parent, int style, boolean synchro, int _look) {
