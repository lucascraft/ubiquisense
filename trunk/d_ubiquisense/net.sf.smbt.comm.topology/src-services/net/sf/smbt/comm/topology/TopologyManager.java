...
import net.sf.smbt.comm.devices.factories.SmbtDeviceAdapterManager;
import net.sf.smbt.comm.discovery.ContinuousDiscoveryAgent;
...
import net.sf.smbt.comm.topology.visitors.ITopologyVisitor;
