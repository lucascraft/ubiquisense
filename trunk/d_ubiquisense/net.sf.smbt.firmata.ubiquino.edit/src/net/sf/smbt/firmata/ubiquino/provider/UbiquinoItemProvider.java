...
/**
 * This is the item provider adapter for a {@link net.sf.smbt.firmata.ubiquino.Ubiquino} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class UbiquinoItemProvider
	 ...
	 * @generated
	 */
	public UbiquinoItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(UbiquinoPackage.Literals.UBIQUINO__BOARD);
			childrenFeatures.add(UbiquinoPackage.Literals.UBIQUINO__CONFIG);
			childrenFeatures.add(UbiquinoPackage.Literals.UBIQUINO__LAST_ADDRESS);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/Ubiquino"));
	}
	...
	public String getText(Object object) {
		return getString("_UI_Ubiquino_type");
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Ubiquino.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(UbiquinoPackage.Literals.UBIQUINO__BOARD,
				 ArduinoFactory.eINSTANCE.createArduino()));

		newChildDescriptors.add
			(createChildParameter
				(UbiquinoPackage.Literals.UBIQUINO__CONFIG,
				 UbiquinoFactory.eINSTANCE.createUbiquinoConfig()));

		newChildDescriptors.add
			(createChildParameter
				(UbiquinoPackage.Literals.UBIQUINO__LAST_ADDRESS,
