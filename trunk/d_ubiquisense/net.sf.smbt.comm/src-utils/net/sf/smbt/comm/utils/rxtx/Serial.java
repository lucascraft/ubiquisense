 ...
 *
 * Contributors:
 * 	   Ben Fry - Initial API and implementation
 *     Casey Reas - Initial API and implementation
...
public class Serial extends IChannelImpl implements ISerialCommunicator, SerialPortEventListener {
