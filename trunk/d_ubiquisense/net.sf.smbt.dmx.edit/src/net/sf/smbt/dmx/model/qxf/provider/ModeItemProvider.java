...
/**
 * This is the item provider adapter for a {@link net.sf.smbt.dmx.model.qxf.Mode} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ModeItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Mode_channel_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Mode_channel_feature", "_UI_Mode_type"),
				 QxfPackage.Literals.MODE__CHANNEL,
				 true,
				 false,
				 false,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 QxfPackage.Literals.MODE__NAME,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(QxfPackage.Literals.MODE__PHYSICAL);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(QxfPackage.Literals.MODE__PHYSICAL,
				 QxfFactory.eINSTANCE.createPhysical()));
	}
