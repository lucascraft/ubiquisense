...
/**
 * This is the item provider adapter for a {@link net.sf.smbt.dmx.model.qxf.Channel} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ChannelItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 QxfPackage.Literals.CHANNEL__NAME,
				 true,
				 false,
				 false,
	...
	protected void addNumberPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Channel_number_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Channel_number_feature", "_UI_Channel_type"),
				 QxfPackage.Literals.CHANNEL__NUMBER,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(QxfPackage.Literals.CHANNEL__GROUP);
			childrenFeatures.add(QxfPackage.Literals.CHANNEL__COLOUR);
			childrenFeatures.add(QxfPackage.Literals.CHANNEL__CAPABILITY);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(QxfPackage.Literals.CHANNEL__GROUP,
				 QxfFactory.eINSTANCE.createGroup()));

		newChildDescriptors.add
			(createChildParameter
				(QxfPackage.Literals.CHANNEL__COLOUR,
				 QxfFactory.eINSTANCE.createColour()));

		newChildDescriptors.add
			(createChildParameter
				(QxfPackage.Literals.CHANNEL__CAPABILITY,
				 QxfFactory.eINSTANCE.createCapability()));
	}
