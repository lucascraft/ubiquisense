...
/**
 * This is the item provider adapter for a {@link net.sf.smbt.dmx.model.qxf.Group} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class GroupItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Group_value_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Group_value_feature", "_UI_Group_type"),
				 QxfPackage.Literals.GROUP__VALUE,
				 true,
				 false,
				 false,
	...
	protected void addBytePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Group_byte_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Group_byte_feature", "_UI_Group_type"),
				 QxfPackage.Literals.GROUP__BYTE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public String getText(Object object) {
		String label = ((Group)object).getValue();
