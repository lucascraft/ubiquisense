...
/**
 * This is the item provider adapter for a {@link net.sf.smbt.ezcosm.Coordinates} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CoordinatesItemProvider
	 ...
	 * @generated
	 */
	public CoordinatesItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Coordinates_lat_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Coordinates_lat_feature", "_UI_Coordinates_type"),
				 EzcosmPackage.Literals.COORDINATES__LAT,
				 true,
				 false,
				 false,
	...
	protected void addLonPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Coordinates_lon_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Coordinates_lon_feature", "_UI_Coordinates_type"),
				 EzcosmPackage.Literals.COORDINATES__LON,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.REAL_VALUE_IMAGE,
	...
	protected void addZoomPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Coordinates_zoom_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Coordinates_zoom_feature", "_UI_Coordinates_type"),
				 EzcosmPackage.Literals.COORDINATES__ZOOM,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		...
		return getString("_UI_Coordinates_type") + " " + coordinates.getLat();
	}
