...
public class XBeeCommPipeConnectionWizardPage extends WizardPage {
	/**
	...
	public XBeeCommPipeConnectionWizardPage() {
		super("USB");
...
/*
						((CommPipeConnectionSelectionWizard)getWizard()).cfg.setUsbComm(
...
*/
		...
		PlatformUI.getWorkbench().getHelpSystem().setHelp(getControl(), "net.sf.smbt.doc.xbee_context"); // NEW
	}
}
