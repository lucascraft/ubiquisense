...
public class HTTPCommPipeConnectionWizardPage extends WizardPage {
	/**
	...
	public HTTPCommPipeConnectionWizardPage() {
		super("USB");
...
*/
		...
		PlatformUI.getWorkbench().getHelpSystem().setHelp(getControl(), "net.sf.smbt.doc.http_context"); // NEW
	}
}
