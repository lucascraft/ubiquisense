 ...
 * <ul>
 *   <li>{@link net.sf.smbt.tests.rgb.rgbargs.impl.RGBStepNDelayArgsImpl#getR <em>R</em>}</li>
 *   <li>{@link net.sf.smbt.tests.rgb.rgbargs.impl.RGBStepNDelayArgsImpl#getG <em>G</em>}</li>
 *   <li>{@link net.sf.smbt.tests.rgb.rgbargs.impl.RGBStepNDelayArgsImpl#getB <em>B</em>}</li>
 *   <li>{@link net.sf.smbt.tests.rgb.rgbargs.impl.RGBStepNDelayArgsImpl#isRMotion <em>RMotion</em>}</li>
 *   <li>{@link net.sf.smbt.tests.rgb.rgbargs.impl.RGBStepNDelayArgsImpl#isGMotion <em>GMotion</em>}</li>
 *   <li>{@link net.sf.smbt.tests.rgb.rgbargs.impl.RGBStepNDelayArgsImpl#isBMotion <em>BMotion</em>}</li>
 *   <li>{@link net.sf.smbt.tests.rgb.rgbargs.impl.RGBStepNDelayArgsImpl#getIncrement <em>Increment</em>}</li>
 *   <li>{@link net.sf.smbt.tests.rgb.rgbargs.impl.RGBStepNDelayArgsImpl#getDelay <em>Delay</em>}</li>
 *   <li>{@link net.sf.smbt.tests.rgb.rgbargs.impl.RGBStepNDelayArgsImpl#isRunning <em>Running</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class RGBStepNDelayArgsImpl extends EObjectImpl implements RGBStepNDelayArgs {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
