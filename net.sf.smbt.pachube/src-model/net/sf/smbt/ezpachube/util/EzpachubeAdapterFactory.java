 ...
 * $Id$
 */
package net.sf.smbt.ezpachube.util;
 ...
 * <!-- end-user-doc -->
 * @see net.sf.smbt.ezpachube.EzpachubePackage
 * @generated
 */
public class EzpachubeAdapterFactory extends AdapterFactoryImpl {
	/**
	 ...
	 * @generated
	 */
	protected static EzpachubePackage modelPackage;
	 ...
	 * @generated
	 */
	public EzpachubeAdapterFactory() {
		if (modelPackage == null) {
			modelPackage = EzpachubePackage.eINSTANCE;
		}
	}
	 ...
	 * @generated
	 */
	protected EzpachubeSwitch<Adapter> modelSwitch =
		new EzpachubeSwitch<Adapter>() {
			@Override
			public Adapter caseCosmCmd(CosmCmd object) {
				return createCosmCmdAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link net.sf.smbt.ezpachube.CosmCmd <em>Cosm Cmd</em>}'.
	 * <!-- begin-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createCosmCmdAdapter() {
		return null;
	}
