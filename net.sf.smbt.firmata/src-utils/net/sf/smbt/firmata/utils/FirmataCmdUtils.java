...
package net.sf.smbt.firmata.utils;
...
public class FirmataCmdUtils {
	...
	public DSLMidiMessage createAnalogIO(int port, float value){
		DSLMidiMessage message =  EzmidiFactory.eINSTANCE.createNoteON();
	...
	public FirmataPinStateResponse createPinStateResponse(byte[] bytes) {
		...
		FirmataPinStateResponse response = EzfirmataFactory.eINSTANCE.createFirmataPinStateResponse();
	...
	public Cmd createCapabiltiesQueryOld() {
		SysexMessage sysexMessage = EzfirmataFactory.eINSTANCE.createFirmataSysexMessage();
	...
	public DSLMidiMessage createProtocolVersionResponse(byte major, byte minor){
		FirmataProtocolVersionCmd message =  EzfirmataFactory.eINSTANCE.createFirmataProtocolVersionCmd();
		message.setAddr(new Integer(ShortMessage.NOTE_ON).byteValue());
	...
	public DSLMidiMessage createSystemReset(){
		 return EzmidiFactory.eINSTANCE.createSystemReset();
	};
