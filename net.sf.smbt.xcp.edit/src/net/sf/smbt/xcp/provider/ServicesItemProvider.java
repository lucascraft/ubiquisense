...
/**
 * This is the item provider adapter for a {@link net.sf.smbt.xcp.Services} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ServicesItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Services_osc_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Services_osc_feature", "_UI_Services_type"),
				 XcpPackage.Literals.SERVICES__OSC,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		OSCPacket labelValue = ((Services)object).getOsc();
